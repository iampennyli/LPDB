...
const NSString *columnNameLock = @"columnNameLock";
const NSString *propertyNameLock = @"propertyNameLock";

@implementation NSString(SQLiteColumnName)
- (NSString *)stringAsSQLColumnName
{
//    static NSMutableDictionary *columnNameDict = nil;
//    @synchronized(columnNameLock) {
//        if (columnNameDict == nil) {
//            columnNameDict = [NSMutableDictionary dictionary];
//        }
//        NSString *result = columnNameDict[self];
//        if (result != nil) {
//            return result;
//        }
//    }
...
//    
//    @synchronized(columnNameLock) {
//        [columnNameDict setValue: ret forKey: self];
//    }
//	return ret;
    return self;
}
...
{
//    static NSMutableDictionary *propertyNameDict = nil;
//    @synchronized(propertyNameLock) {
//        if (propertyNameDict == nil) {
//            propertyNameDict = [NSMutableDictionary dictionary];
//        }
//        NSString *result = propertyNameDict[self];
//        if (result != nil) {
//            return result;
//        }
//    }
...
//	}
//    @synchronized(propertyNameLock) {
//        [propertyNameDict setValue: ret forKey: self];
//    }
//	return ret;
    return self;
}
